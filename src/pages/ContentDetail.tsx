...
export default function ContentDetail() {
  ...
  const addComment = useMutation({
    mutationFn: async (data: CommentFormData) => (await api.post(`/interactions/comments/${id}` , data)).data,
    onSuccess: () => {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="shadow-soft">
            ...
            <CardContent className="space-y-4">
              ...
              <form onSubmit={commentForm.handleSubmit((d) => addComment.mutate(d))} className="space-y-2">
